...
if "apps.autoconfig" in settings.INSTALLED_APPS:
    urlpatterns += [url(r"^mail/", include("apps.autoconfig.urls"))]
...
if "apps.contact" in settings.INSTALLED_APPS:
    urlpatterns += [url(r"^contact/", include("apps.contact.urls"))]

if "apps.contribution" in settings.INSTALLED_APPS:
    urlpatterns += [url(r"^contribution/", include("apps.contribution.urls"))]
...
if "apps.feedback" in settings.INSTALLED_APPS:
    urlpatterns += [url(r"^feedback/", include("apps.feedback.urls"))]
...
if "apps.slack" in settings.INSTALLED_APPS:
    urlpatterns += [url(r"^slack/", include("apps.slack.urls"))]
...
if "apps.chunksapi" in settings.INSTALLED_APPS:
    urlpatterns += [url(r"^chunks/", include("apps.chunksapi.urls"))]

if "apps.payment" in settings.INSTALLED_APPS:
    urlpatterns += [url(r"^payment/", include("apps.payment.urls"))]

# redwine
if "redwine" in settings.INSTALLED_APPS:
    urlpatterns += [url(r"^redwine/", include("redwine.urls"))]
